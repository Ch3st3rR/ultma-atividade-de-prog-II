       ...
       <div class="row">
               ...
               <div class="table-responsive">
                   <table class="table-striped table-responsive" style="text-align: center; font-size: 12px;">
                    <button type="button" class="btn btn-primary btn-lg btn-block">Preços Instalações</button>
                       <thead class="thead-light">
                           <tr>
                              <th scope="col" class="col-1">Proposta</th>
                               ...
                               <th scope="col" class="col-1">Estimado M.O </th>
                               <th scope="col" class="col-1">Usado M.O</th>
                               <th scope="col" class="col-1">Estimado Material </th>
                               <th scope="col" class="col-1">Usado Material</th>
                       ...
                       <tbody>
                        ...
                        include_once ("conexao.php");
                          ...
                          while ($dados = mysqli_fetch_assoc($teste)) 
                          {
                            ...
                            echo"<td> R$ ".$dados['maodeobraestimada']."</td>";
                            echo"<td> R$ ".$dados['maodeobrausada']."</td>";
                            echo"<td> R$ ".$dados['materialestimado']."</td>";
                            echo"<td> R$ ".$dados['materialusado']."</td>";
                            echo"<td>
                                  <a class='btn btn-primary' href='atualiza_preco.php?id=$dados[id]'>
...
<script>
    ...
    function searchData()
    {
        window.location = 'atualizaprecos.php?search='+search.value;
    }
</script> 
</html>
