       ...
       <div class="row">
               ...
               <div class="table-responsive">
                   <table class="table-striped table-responsive" style="text-align: center; font-size: 12px;">
                    <button type="button" class="btn btn-primary btn-lg btn-block">Pendencias Instalações</button>
                       <thead class="thead-light">
                           <tr>
                              <th scope="col" class="col-1">Os</th>
                               ...
                               <th scope="col" class="col-1">Agendamento</th>
                               <th scope="col" class="col-1">Equipe</th>
                       ...
                       <tbody>
                        <?php
                          ...
                          $query = "select * from instalacao where status like 'Pendente'";
                          ...
                          while ($dados = mysqli_fetch_assoc($teste)) 
                          {
                            ...
                            echo"<td>
                                  <a class='btn btn-primary' href='atualiza_instalacao.php?id=$dados[id]'>
                                  ...
                                  <a class='btn btn-danger' href='atualiza_obs_instalacao.php?id=$dados[id]'>
